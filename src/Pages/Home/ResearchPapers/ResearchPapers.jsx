...
const ResearchPapers = () => {
    ...
    const recommendedPapers = [
        ...
        },
        {
          ...
          {
            title: 'Emerging Trends in E-commerce: A Data-Driven Analysis',
            author: 'Emma Wilson',
            year: '2023',
            link: 'https://moonpreneur.com/blog/latest-developments-in-artificial-intelligence/'
          }
                ...
                <div className='grid grid-cols-1 md:grid-cols-4'>
                    {recommendedPapers.map((paper, index) => (
                        <div className='' key={index}>
                            <div className='card w-80 h-60 mb-4 glass shadow-xl'>
                                <div className='card-body flex flex-col justify-between'>
                                    ...
                                    <div >
                                        <Link to={paper.link} target="_blank" rel="noopener noreferrer"><button className='btn bg-sky-800 text-white hover:text-sky-800'>Read Paper</button></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
